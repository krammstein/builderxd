...
import type { DeviceMode, Language, FileManagerProvider, ESPIntegration, UIConfig } from '../types';
import {
  Monitor,
  Tablet,
  Smartphone,
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="h-[60px] bg-bg-panel border-b border-border-color flex items-center justify-between px-5 z-50 shadow-sm shrink-0">
      {/* Title & Brand */}
      ...
      {/* Responsive Selector */}
      {uiConfig?.showDeviceToggle !== false && (
      ...
      <div className="flex items-center gap-4">
        {/* History */}
        {uiConfig?.showHistoryToggle !== false && (
        ...
        {/* Theme Toggle */}
        {uiConfig?.showThemeToggle !== false && (
          <button
            onClick={toggleTheme}
        ...
        {/* Language Selector */}
        {uiConfig?.showLanguageToggle !== false && (
