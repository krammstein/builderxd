...
export const LeftPanel: React.FC<LeftPanelProps> = ({
  ...
  const availableComponents = [
    ...
    { type: 'heading1' as BlockType, label: 'Título H1', icon: <Type size={24} /> },
    { type: 'heading2' as BlockType, label: 'Título H2', icon: <Type size={24} /> },
    { type: 'heading3' as BlockType, label: 'Título H3', icon: <Type size={24} /> },
    { type: 'heading4' as BlockType, label: 'Título H4', icon: <Type size={24} /> },
