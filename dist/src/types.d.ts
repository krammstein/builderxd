export type BlockType = 'section' | 'column' | 'text' | 'heading' | 'paragraph' | 'image' | 'button' | 'divider' | 'spacer' | 'social' | 'video' | 'custom_html' | 'countdown' | 'accordion' | 'carousel' | 'icon' | 'nav_menu' | 'image_text' | 'product_card' | 'quote' | 'table' | 'wrapper' | 'group' | 'hero' | 'slider' | 'gallery' | 'flex_layout' | 'grid_layout';
