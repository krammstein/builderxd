...
- **Heading & Paragraph Blocks**: Split the single `text` component into distinct H1, H2, H3, H4, and Paragraph draggable blocks, each initialized with semantic defaults (font weights, font sizes).
